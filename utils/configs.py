...
def parse_configs():
    ...
    parser.add_argument(
        ...
        type=str,
        default="concat",
        help="method to join embeddings",
        choices=["concat", "max", "add"],
    )
    parser.add_argument(
        "--join-location",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="ignore a modality for ablation study",
        choices=["xrd", "sem"],
    )
    ...
    parser.add_argument("--use-label-masking-baseline", action="store_true", help="use label masking baseline")
